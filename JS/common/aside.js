...
function onlineshop_btn_op(){
    ...
    document.getElementById('onlineshop_btn').setAttribute('onclick','onlineshop_btn_close()');
}
...
function onlineshop_btn_close(){
    ...
    document.getElementById('onlineshop_btn').setAttribute('onclick','onlineshop_btn_op()');
}
...
function brand_btn_op(){
    ...
    document.getElementById('brand_btn').setAttribute('onclick','brand_btn_close()');
}
...
function brand_btn_close(){
    ...
    document.getElementById('brand_btn').setAttribute('onclick','brand_btn_op()');
}
